#!/usr/bin/env python3
"""
Create a comprehensive yoga library with detailed poses, instructions, and benefits
...
class ComprehensiveYogaLibrary:
    def __init__(self):
        self.yoga_poses = []
        self.sequences = []
        self.pranayama_techniques = []
        
    def create_comprehensive_poses(self) -> List[Dict[str, Any]]:
        """Create comprehensive yoga poses with detailed instructions"""
    ...
    def create_sequences(self) -> List[Dict[str, Any]]:
        """Create yoga sequences for different doshas"""
    ...
    def create_pranayama_techniques(self) -> List[Dict[str, Any]]:
        """Create pranayama techniques for different doshas"""
    ...
    def save_comprehensive_data(self):
        """Save all comprehensive yoga data"""
        
        poses = self.create_comprehensive_poses()
        sequences = self.create_sequences()
        pranayama = self.create_pranayama_techniques()
        
        # Create categories
        categories = [
            {"name": "Restorative", "description": "Gentle, calming poses for relaxation", "count": len([p for p in poses if p['category'] == 'Restorative'])},
        ...
        # Save to file
        output_path = "/Users/god/Downloads/Mero pahichan/src/assets/comprehensive_yoga_library.json"
        with open(output_path, 'w', encoding='utf-8') as f:
            json.dump(comprehensive_data, f, indent=2, ensure_ascii=False)
        
        print(f"Created comprehensive yoga library with {len(poses)} poses, {len(sequences)} sequences, and {len(pranayama)} pranayama techniques")
        print(f"Saved to: {output_path}")

def main():
    library = ComprehensiveYogaLibrary()
    library.save_comprehensive_data()
