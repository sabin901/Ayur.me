...
export function AccessibleCard({ title, description, children, level = 3 }: AccessibleCardProps) {
  // Narrow to actual heading elements only — `keyof JSX.IntrinsicElements`
  // also includes things like <image>/<line> from @react-three/fiber's
  // ambient declarations, which take very different props.
