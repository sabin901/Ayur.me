...
const stats: { label: string; value: string; icon: typeof BookOpen; iconClass: string }[] = [
  { label: "Ancient Texts", value: "500+", icon: BookOpen, iconClass: "text-gold" },
  { label: "Herbal Remedies", value: "1000+", icon: Leaf, iconClass: "text-green-600" },
  { label: "Expert Guidance", value: "24/7", icon: Shield, iconClass: "text-amber-600" },
  { label: "Years of Wisdom", value: "5000+", icon: Clock, iconClass: "text-earth" },
];
        ...
        <div className="relative py-32 lg:py-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="slide-up mt-12 flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                ...
                <Button variant="outline" size="xl" className="bg-transparent border-white/30 text-white hover:bg-white/10 backdrop-blur-sm hidden md:flex" asChild>
                  <Link to="/diseases">
                  ...
                  <div className="relative z-10 h-full p-8 flex items-center justify-center">
                    <div className="text-center space-y-6">
                      <div className="mx-auto w-20 h-20 rounded-full bg-gold/20 flex items-center justify-center">
                        <Compass className="h-12 w-12 text-gold" />
                      </div>
